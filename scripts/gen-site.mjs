...
const NAV = active => `<nav class="nav"><div class="wrap">
  ...
  <div class="right"><a class="btn btn-hot" href="/">Open the app →</a></div>
</div></nav>`;
...
const FOOTER = (b) => {
  ...
  return `<footer><div class="wrap"><div class="fcols">
    <div><div class="brand" style="font-size:13px"><span class="m" style="width:26px;height:26px;font-size:13px">◎</span> Shuug</div><p class="mut" style="max-width:320px;font-size:13px;margin-top:12px">The free back office behind your business. Own it, host it, move it.</p><span class="badge" style="margin-top:12px">Prototype</span></div>
    ...
    ${sibLinks}
    <div><h6>Get started</h6><a href="/">Open the app</a><a href="/welcome/bookkeeping">Free bookkeeping</a></div>
  </div></div></footer>`;
};
